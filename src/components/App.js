          ...
          <Route
            ...
            render={() => (
              <HomepageLayoutContainer
                starSetter={this.props.starSetter}
                bookSetter={this.props.bookSetter}
              />
            )}
          />
          <Route
            ...
            path="/allstars"
            render={() => (
              <AllStarsLayoutContainer starSetter={this.props.starSetter} />
            )}
          />
          <Route
            exact
            path="/allbooks"
            render={() => (
              <AllBooksLayoutContainer bookSetter={this.props.bookSetter} />
            )}
          />
