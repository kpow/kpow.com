      ...
      <div style={{ marginTop: '55px' }}>
        <Responsive as={Container} {...Responsive.onlyMobile}>
          {this.props.stars ? (
            <Stars
              totalItemsInView={1}
              totalItems={this.props.totalStars}
              data={this.props.stars}
              dataSetter={this.props.starSetter}
            />
          ) : (
            <Container text>
              <h1>Loading...</h1>
          ...
          {this.props.grams ? (
            <InstagramFeed
              totalItemsInView={1}
              totalItems={this.props.grams.length}
              data={this.props.grams}
              dataSetter={this.instagramSetter}
            />
          ) : (
            <Container text>
              <h1>Loading...</h1>
        ...
        {this.props.projects ? (
          <Projects data={this.props.projects} />
        ) : (
          <Container text>
...
export const HomepageLayoutContainer = connect(mapStateToProps, actionCreators)(
  HomepageLayout
);
